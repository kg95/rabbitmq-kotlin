...
class DefaultConverterTest {
    ...
    fun testToByteArray_notSupportedType() {
        ...
        assertThat(DefaultConverter().toByteArray(testBoolean, Boolean::class.java)).isNull()
    }

    @Test
    fun testToObject_notSupportedType() {
        val testByteArray = true.toString().toByteArray()
        assertThat(DefaultConverter().toObject(testByteArray, Boolean::class.java)).isNull()
    }
}
